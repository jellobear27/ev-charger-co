...
export default function BenefitCard({ title, description, icon, color, delay }: BenefitCardProps) {
  ...
  return (
    <div
      ref={cardRef}
      className={`bg-white p-8 rounded-2xl shadow-xl text-center transform transition-all duration-300 hover:shadow-2xl border-2 border-transparent hover:border-${color}-200`}
