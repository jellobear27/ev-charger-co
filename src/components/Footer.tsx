      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="sm:col-span-2">
            ...
            {/* Social media links hidden until setup complete */}
          ...
          {/* Contact Info */}
          <div className="border-t sm:border-t-0 sm:border-l border-gray-700 pt-6 sm:pt-0 sm:pl-8">
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span className="text-sm sm:text-base">Apply via our form</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-6 sm:mt-8 pt-6 sm:pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            ...
            <div className="flex flex-wrap justify-center sm:justify-end space-x-4 sm:space-x-6">
              <Link href="#" className="text-gray-400 hover:text-emerald-400 text-xs sm:text-sm transition-colors">
                Privacy Policy
              </Link>
              <Link href="#" className="text-gray-400 hover:text-emerald-400 text-xs sm:text-sm transition-colors">
                Terms of Service
