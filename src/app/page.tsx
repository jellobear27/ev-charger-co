          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 mt-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-white/20">
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6 text-center lg:text-left font-montserrat">Why California Businesses Are Installing EV Chargers — At Zero Cost</h3>
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    ...
                    <div>
                      <div className="text-xl sm:text-2xl font-bold text-white font-poppins">We Handle It All</div>
                      <div className="text-gray-200 text-sm sm:text-base font-montserrat">Engineering & Permitting</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    ...
                    <div>
                      <div className="text-xl sm:text-2xl font-bold text-white font-poppins">Monthly Passive</div>
                      <div className="text-gray-200 text-sm sm:text-base font-montserrat">Income</div>
                    </div>
                  </div>
                </div>
              </div>
