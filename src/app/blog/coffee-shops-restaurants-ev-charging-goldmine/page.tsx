        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="relative h-96">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
              <div className="text-center text-white">
                ...
                <p className="text-xl">Why food service businesses are perfectly positioned to profit from EV charging</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">The Perfect Marriage: Food Service + EV Charging</h2>
              ...
              <div className="bg-blue-50 border-l-4 border-blue-400 p-6 my-8">
                <h3 className="text-lg font-semibold text-blue-800 mb-2">The Numbers Don't Lie</h3>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Why Food Businesses Are EV Charging Champions</h2>
              
              <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">☕ Coffee Shops: The Ultimate EV Charging Companion</h3>
              <div className="bg-gray-50 p-6 rounded-lg mb-6">
                ...
                <h4 className="font-semibold text-gray-900 mb-3 mt-4">Revenue Multipliers:</h4>
                <ul className="text-gray-700 space-y-2 ml-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">🍕 Restaurants: Captive Audience Advantage</h3>
              <div className="bg-gray-50 p-6 rounded-lg mb-6">
                ...
                <h4 className="font-semibold text-gray-900 mb-3 mt-4">Fine Dining Benefits:</h4>
                <ul className="text-gray-700 space-y-2 ml-4">
              ...
              <div className="bg-green-50 border-l-4 border-green-400 p-6 my-8">
                <h3 className="text-lg font-semibold text-green-800 mb-2">Real Success Story: Blue Bottle Coffee, Oakland</h3>
                ...
                <p className="text-green-600 font-semibold mt-2">- Sarah Kim, Blue Bottle Coffee Oakland (Hypothetical example)</p>
              </div>

              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">The Competitive Edge You Need</h2>
              
              <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">🎯 Customer Acquisition</h3>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">🔒 Customer Retention</h3>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">💰 Revenue Streams</h3>
              <div className="grid md:grid-cols-2 gap-4 my-6">
                <div className="bg-white border border-gray-200 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">Direct Revenue</h4>
                ...
                <div className="bg-white border border-gray-200 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">Indirect Revenue</h4>
                  <ul className="text-gray-700 text-sm space-y-1">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Types of Food Businesses Perfect for EV Charging</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">What About Competition?</h2>
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-6 my-8">
                <h3 className="text-lg font-semibold text-yellow-800 mb-2">⚡ First-Mover Advantage</h3>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Getting Started: Easier Than You Think</h2>
              
              <div className="bg-green-50 p-6 rounded-lg my-8">
                <h3 className="font-semibold text-green-800 mb-4">Simple 3-Step Process:</h3>
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-green-800">Quick Application (5 minutes)</h4>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-green-800">Free Site Assessment</h4>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-green-800">Professional Installation</h4>
              ...
              <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Requirements (Most restaurants qualify):</h3>
              ...
              <div className="bg-gradient-to-r from-green-600 to-green-700 text-white p-8 rounded-lg text-center my-12">
                <h2 className="text-2xl font-bold mb-4">Ready to Transform Your Restaurant's Revenue?</h2>
                <p className="text-lg mb-6">Join the smart food business owners already profiting from California's EV boom</p>
